...
const PROJECTS = [
  {
    title: "יום הולדת אמא מירית 🎂",
    description: "הפתעה מיוחדת ליום ההולדת של אמא מירית — עם עוגה, נרות לנשיפה, קונפטי ומכתב אהבה מהלב.",
    url: "./birthday-mirit/",
    icon: "🎂"
  },
  {
    title: "יום הולדת מירית ❤️",
    description: "אתר יום הולדת מיוחד לאמא מירית.",
    url: "./birthday-mirit/",
    icon: "❤️",
    password: "1203169"
  },
